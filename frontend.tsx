    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&to=info@theleadgen.io"
...
function IntakeForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(
      `https://mail.google.com/mail/?view=cm&to=info@theleadgen.io&su=${subject}&body=${body}`,
      "_blank"
    );
        ...
        >
          ...
          {status === "error" && (
            <p className="text-red-400 text-sm text-center">
              ...
              <a href="https://mail.google.com/mail/?view=cm&to=info@theleadgen.io" className="underline">
                info@theleadgen.io
              </a>
            </p>
          )}
